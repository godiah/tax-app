        ...
        <div class="mx-auto px-6 sm:px-8 lg:px-12">
            <div class="flex justify-between items-center py-3">
                ...
                <div class="hidden md:flex items-center space-x-2">
                    ...
                    <a href="{{ route('invoices.index') }}"
                        class="font-secondary {{ request()->routeIs('invoices.*') ? 'text-accent' : 'text-dark hover:text-primary' }} hover:text-primary transition-colors px-3 py-2 rounded-md hover:bg-gray-50 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="hidden peer-checked:block md:hidden bg-white border-t border-gray-200 shadow-lg">
                <div class="px-4 py-3 space-y-2">
                    ...
                    <a href="{{ route('invoices.index') }}"
                        class="block py-2 px-3 {{ request()->routeIs('invoices.*') ? 'text-accent bg-light' : 'text-dark' }} hover:bg-light rounded-md hover:text-primary font-secondary flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
