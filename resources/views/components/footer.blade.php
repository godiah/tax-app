        ...
        <div class="flex flex-col items-center  md:items-start space-y-4">
            ...
            <div class="flex space-x-3 mt-4">
                ...
                <a href="https://www.linkedin.com/in/duncan-gateru-33bb02145/" target="_blank"
                    aria-label="Visit Duncan Gateru on LinkedIn" class="text-white hover:text-accent transition-colors">
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        {{-- LinkedIn Icon --}}
                        <path
                ...
                {{-- </svg> --}}
                {{-- </a> --}}
                <a href="https://wa.me/254723881440" target="_blank" aria-label="Chat on WhatsApp"
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm font-secondary">
                <li class="flex items-start space-x-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-accent mt-0.5 shrink-0" fill="none"
                    ...
                    <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode('Mobile Plaza, Nairobi, Kenya') }}"
                        ...
                        class="hover:text-accent transition-colors duration-300 text-left">
                ...
                <li class="flex items-center space-x-3">
                    ...
                    <a href="tel:+254723881440" class="hover:text-accent transition-colors duration-300">
                        (+254) 723-881-440
                    </a>
                </li>
                <li class="flex items-center space-x-3">
                    ...
                    <a href="mailto:info@taxgenconsulting.com" class="hover:text-accent transition-colors duration-300">
