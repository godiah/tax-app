<section id="about" class="bg-light-gray py-16 lg:py-24">
    <div class="container mx-auto px-4 grid md:grid-cols-2 gap-10 max-w-7xl">
        ...
        <div class="space-y-6">
            ...
            {{-- <div class="pt-2" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800">
                <a href="#contact"
                    class="bg-gradient-to-r from-primary to-secondary hover:from-primary-hover hover:to-secondary text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 inline-flex items-center">
